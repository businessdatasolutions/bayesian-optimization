...
# --- MODIFIED ANNOTATIONS WITH SMALLER FONTS ---
fig_acq.add_annotation(text="<b>EXPLOIT</b><br>High value likely", x=7.5, y=np.max(ei)*0.85, arrowhead=2, ax=0, ay=-30, font_size=11, row=2, col=1)
fig_acq.add_annotation(text="<b>EXPLORE</b><br>High uncertainty", x=16, y=np.max(ei)*0.55, arrowhead=2, ax=0, ay=-30, font_size=11, row=2, col=1)

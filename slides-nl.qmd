...
::: {.center}
*Klaar voor de praktijk: in onze interactieve demo's ervaart u zelf de kracht van slimmer optimaliseren.*
:::
...
<div>
<h2 style="color: #fd7e14;">💰 Wat maakt experimenteren duur?</h2>
...
<li><strong>Energie:</strong> Aandacht, operationele verstoring</li>
<li><strong>Middelen:</strong> Personeel, rekenkracht</li>
</ul>
<p style="margin-top: 15px; font-weight: bold; color: #d63031;">❌ Duizenden scenario's testen is vaak simpelweg onmogelijk.</p>
</div>
</div>
...
Puur gokwerk is inefficiënt. <strong>Het is tijd voor een slimmere strategie.</strong>
</p>
</div>

<div style="text-align: center; margin-top: 30px; font-size: 1.1em; color: #666;">
<strong>Bayesian Optimization - Laten we ontdekken hoe het werkt →</strong>
</div>
...
::: {style="background: #f8f9fa; padding: 15px; border-radius: 8px; border-left: 4px solid #007bff; margin-top: 20px; font-size: 0.9em;"}
**💡 De Kern:** Het algoritme balanceert continu tussen verkennen (speelveld in kaart brengen) en exploiteren (goudaders aanboren).
:::
...
<div style="margin-bottom: 6px;"><span style="color: #2ecc71;">●</span> <strong>Groen oppervlak:</strong> De kostenvoorspelling van de AI</div>
...
<p style="font-size: 1.1em; margin: 0;">De formule voor efficiëntie, kostenbesparing en een versneld inzicht</p>
</div>
...
<p style="font-size: 0.9em; margin: 0;">Vind de optimale parameters voor uw demand forecasting- en ML-modellen.</p>
</div>
